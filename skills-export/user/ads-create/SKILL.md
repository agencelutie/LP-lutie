...
- **Not found**: Ask the user whether to run `/ads dna <url>` first or describe their brand manually.
...
- **Found**: Read them. Note the top 3 weaknesses to address in concepts.
...
### Step 4: Generate Campaign Concepts & Brief

Create `campaign-brief.md` with this structure:
...
## Copy Deck
[platform-specific headlines, primary text, and CTAs for each concept]
...
Confirm `campaign-brief.md` exists and is complete. Present a summary to the user:
